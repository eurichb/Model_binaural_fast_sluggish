function ids_lateralization_savefcn
...
ids_out = [];
    ...
    for i = 1:tmpinterleavenum
        ...
        answertmp = work.answer{i}(endstepsizeindex + 1 : end);
        
         ids_out = add_spar(ids_out, restmp ,def.expvardescription,'unit',def.expvarunit);
